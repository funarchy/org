...
1. **Numbered governance docs (`01`–`06`)** — charter, bylaws, roadmap, amendment process, treasury wallet, onboarding. Numbers are reading/dependency order. The charter (`01-charter.md`) and `products/` are reviewed line by line and the author stands behind every sentence; `02`–`06` are drafts still in progress.
