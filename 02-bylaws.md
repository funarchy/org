...
Founder," it is thereafter exercised by the Founder and the Partner
...
**Focus Areas:**
- Stabilize the core products - Space, RPPS, scenepad (see [products/](products/README.md))
- Publish bylaws, charter, roadmap
- Recruit initial cooperators
...
- Voting mechanism: quadratic, delegated, or consensus (designed in the Federated Phase)
- Founder's and Partner's power progressively reduced (advisory role only)
- Charter fully community-proposable (with vetting process)

### Article 10: Amendment Process (Pollutions and Solutions)

Funarchy amends its governing rules through a problem-first process:
...
- The **public forum** is where pollutions and solutions are discussed;
  the **public record** is the version-controlled repository where adopted
  changes land. Their current technical bindings are maintained in the
  tooling registry (`tooling.md`) and may be replaced without amending
  these bylaws.

**The process:**

1. **Report:** a pollution is filed in the public forum, stating the
   problem, who it affects, the cost of not fixing it, and acceptance
   criteria
2. **Prioritize:** the phase decider assigns a public priority. Priority
   orders attention; it is not a validity judgment and not a gate - any
   open pollution may be answered at any time, and priorities may be
   publicly challenged
...
> **Note for legal counsel:** whether the pollution/solution terminology
> can be kept verbatim in the filed Serbian version, or needs a
> conventional gloss (e.g., "problem report" / "proposed amendment") with
> these terms as defined aliases, is a topic for discussion with a local
...
### Article 11: Treasury & Crypto Operations
...
**Funding Sources:**
- Salary-split contribution via the Founding Adviser arrangement
- Donations (crypto preferred; fiat accepted)
- Space hosting revenue (Hetzner-based instances)
...
### Article 13: Monthly Treasury Reports

Published on the 1st of each month in the public record:

- Total inflows (donations, grants, SaaS revenue, consulting, salary-split contribution)
- Total outflows (salary, contractor pay, infrastructure, operations)
- Current balance (on-chain wallet balance)
- Runway/growth projection
- Breakdown by revenue stream and expense category
...
## VIII. Record-Keeping & Amendments
...
### Article 17: Amendment to Bylaws

These bylaws may be amended via the process in Article 10.
