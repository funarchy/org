...
One more honest fact: until a legal entity exists to hold the treasury, the funds are legally the Founder's personal property, whatever the reports call them. The reports state this rather than hide it (see the legal-form ladder in [03-roadmap.md](03-roadmap.md)).
